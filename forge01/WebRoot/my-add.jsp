							...
							<div class="payment-interface w1200">
								<div class="pay-info">
									...
									<ul class="pay-dz">
										<li class="current">
											<h3>
												<span class="sp1">东胜神洲</span><span class="sp2">傲来国</span>（<span
													class="sp3">佩奇</span> 收）
											</h3>
											<p>
												<span class="sp1">傲来国花果山水帘洞</span><span
													class="sp2">18983945092</span>
											</p> <a href="JavaScript:;" xiugai="">修改</a>
										</li>
										<li>
											<h3>
												<span class="sp1">南赡部洲</span><span class="sp2">东土大唐</span>（<span
													class="sp3">佩奇</span> 收）
											</h3>
											<p>
												<span class="sp1">长安长治街北91号当铺</span><span class="sp2">18888888888</span>
											</p> <a href="JavaScript:;" xiugai="">修改</a>
										</li>
										...
										<dl class="checkout-goods-list">
													...
													<div class="col col-1">
														...
														<div class="g-info">
															<a href="#" target="_blank">
																赛亿（shinee)取暖器家用/取暖电器/电暖器/电暖气台式摇头暖风机HN2118PT </a>
														</div>
													</div>
											...
											<dd class="item clearfix">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
															<img src="images/shangpinxiangqing/X-1.png" width="40"
																height="40" />
														</div>
														<div class="g-info">
															<a href="#" target="_blank">
											...
											<dd class="item clearfix">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
															<img src="images/shangpinxiangqing/X2.png" width="40"
																height="40" />
														</div>
														<div class="g-info">
															<a href="#" target="_blank">

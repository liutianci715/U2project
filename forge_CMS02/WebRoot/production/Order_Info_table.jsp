              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="/forge_CMS02/OrdersServlet?method=update" method="post" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly"  name="id" value="${order.id }" id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"    type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly"  name="userId" value="${order.userId}" id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"    type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="loginName" value="${requestScope.order.loginName}" type="text" id="email"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="userAddress" value="${requestScope.order.userAddress}" type="text" id="email2"   class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="email">订单创建时间<span class="required" ></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="createTime" value= "${requestScope.order.createTime}"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="website">订单状态 <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="status" type="url"value="${requestScope.order.status}" id="website"  placeholder="www.website.com" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="website">订单类型<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="type" type="url"value="${requestScope.order.type }" id="website"  placeholder="www.website.com" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      
                         <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="website">订单序号<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="serialNumber" type="url"value="${requestScope.order.serialNumber }" id="website"  placeholder="www.website.com" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

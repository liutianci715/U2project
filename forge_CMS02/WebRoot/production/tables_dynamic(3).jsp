                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <c:forEach items="${sessionScope.orderList}" var="orders">
	                      <tr>
	                          ...
	                          <a href="/forge_CMS02/OrdersServlet?method=findById&id=${orders.id}" class="btn btn-success" >修改订单</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                          <a  type="button" class="btn btn-primary" href="javascript:del('/forge_CMS02/OrdersServlet?method=delete&id=${orders.id}')">删除订单</a></td>
	                        </tr>
                      </c:forEach>
